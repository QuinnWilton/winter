...
use winter_claude::{Client, StreamFormat};
...
async fn simple_query() -> winter_claude::Result<()> {
...
async fn configured_query() -> winter_claude::Result<()> {
...
async fn full_response_query() -> winter_claude::Result<()> {
...
async fn stream_format_comparison() -> winter_claude::Result<()> {
