...
use winter_claude::{Client, Message, StreamFormat};
...
async fn basic_streaming() -> winter_claude::Result<()> {
...
async fn streaming_with_metadata() -> winter_claude::Result<()> {
...
async fn streaming_with_tools() -> winter_claude::Result<()> {
...
async fn streaming_with_progress() -> winter_claude::Result<()> {
    use std::sync::{
