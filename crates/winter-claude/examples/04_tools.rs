...
use winter_claude::{Client, ToolPermission};
...
async fn basic_tools() -> winter_claude::Result<()> {
...
async fn file_operations() -> winter_claude::Result<()> {
    println!("\n2. File Operations");
...
async fn dev_workflow() -> winter_claude::Result<()> {
...
async fn code_review_assistant() -> winter_claude::Result<()> {
