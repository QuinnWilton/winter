use winter_claude_core::{Config, SessionId, StreamFormat};
...
mod streaming_tests {
    ...
    async fn test_message_stream_creation() {
        use winter_claude_core::Message;
        use tokio::sync::mpsc;
    ...
    async fn test_message_stream_collect() {
        use winter_claude_core::{Message, MessageMeta};
        use tokio::sync::mpsc;
        ...
        let result_message = Message::Result {
            ...
            stats: winter_claude_core::ConversationStats {
                total_messages: 1,
                total_cost_usd: 0.0,
                total_duration_ms: 0,
                total_tokens: winter_claude_core::TokenUsage {
                    input: 0,
                    output: 0,
                    total: 0,
                },
    ...
    async fn test_streaming_timeout_recovery() {
        use winter_claude_core::{Error, Message, MessageMeta};
        use tokio::sync::mpsc;
        use tokio::time::{timeout, Duration};
