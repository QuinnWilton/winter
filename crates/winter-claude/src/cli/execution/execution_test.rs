        ...
        (
            ...
            .prop_map(|(timeout_secs, streaming, json_format, max_retries, retry_delay_secs)| {
                let stream_format = if json_format {
                    winter_claude::StreamFormat::Json
                } else {
                    winter_claude::StreamFormat::Text
                };
...
mod runner_tests {
    ...
    async fn test_config_update() -> Result<()> {
        ...
        let new_config = RunnerConfig {
            ...
            streaming: false,
            stream_format: winter_claude::StreamFormat::Json,
            max_retries: 5,
...
mod integration_tests {
    ...
    async fn test_runner_with_different_configs() -> Result<()> {
        ...
        let config1 = RunnerConfig {
            timeout: Duration::from_secs(60),
            streaming: true,
            stream_format: winter_claude::StreamFormat::StreamJson,
            max_retries: 2,
        ...
        let config2 = RunnerConfig {
            ...
            streaming: false,
            stream_format: winter_claude::StreamFormat::Text,
            max_retries: 1,
