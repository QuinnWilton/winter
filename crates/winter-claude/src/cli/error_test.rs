...
mod error_conversion_tests {
    ...
    // Note: We can't easily test winter_claude::Error conversion without the actual SDK
}
...
mod user_friendly_message_tests {
        ...
        let test_cases = vec![
            ...
            (
                ...
                vec![
                    "work-session-123",
                    "not found",
                    "claude-interactive session list",
                ],
            ),
            (
    ...
    fn test_claude_sdk_error_message() {
        // We can't create a real winter_claude::Error, but we can test the message format
