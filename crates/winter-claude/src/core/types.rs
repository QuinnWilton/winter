...
///
/// ```rust
/// use winter_claude_core::ExtractedToolCall;
/// use serde_json::json;
///
...
///
/// ```rust
/// use winter_claude_core::ClaudeCliResponse;
/// use serde_json;
///
...
///
/// ```rust
/// use winter_claude_core::ClaudeResponse;
///
...
///
/// ```rust
/// use winter_claude_core::ResponseMetadata;
///
/// // Accessing metadata from a response
/// # let response = winter_claude_core::ClaudeResponse::text("test".to_string());
...
///
/// ```rust
/// use winter_claude_core::TokenUsage;
///
/// # let response = winter_claude_core::ClaudeResponse::text("test".to_string());
/// if let Some(metadata) = &response.metadata {
...
///
/// ```rust
/// use winter_claude_core::ToolPermission;
///
