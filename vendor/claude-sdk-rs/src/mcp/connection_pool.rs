...
use crate::mcp::{
    clients::{MCPClient, StdioMCPClient, WebSocketMCPClient},
    core::error::{
        circuit_breaker::{CircuitBreakerConfig, CircuitBreakerRegistry},
        WorkflowError,
    },
    health::{ConnectionHealthMonitor, HealthConfig, HealthStatus},
    load_balancer::{ConnectionInfo, MCPLoadBalancer},
...
impl MCPConnectionPool {
    ...
    // pub async fn get_circuit_breaker_metrics(&self) -> HashMap<String, crate::mcp::core::error::circuit_breaker::CircuitBreakerMetrics> {
...
pub struct ServerHealthInfo {
    ...
    // pub circuit_metrics: crate::mcp::core::error::circuit_breaker::CircuitBreakerMetrics,
}
